$(function() {
    // Only initialize PerfectScrollbar if elements exist
    ['tasks-inner', 'tab-table-1', 'tab-table-2'].forEach(function(id) {
...
$(document).ready(function() {
    setTimeout(function() {
        // Bar Chart
        $(function() {
            // Only initialize chart if element exists
            if (document.getElementById('statistics-chart-1')) {
                try {
