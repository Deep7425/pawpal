...
class AppointmentOrder extends Authenticatable {
    ...
    protected $fillable = ['login_id' , 'type' , 'name' , 'appt_type' ,'patient_id','appointment_id','coupon_id','coupon_discount','service_charge_meta','service_charge','order_subtotal','order_total','order_status','app_date','doc_id','order_by','switch_apt','rating','order_from','referral_code','hg_miniApp','meta_data', 'razorpay_order_id'];
