        ...
        <table class="table" style=" width:100%;" cellpadding="0" cellspacing="0">
          <tbody>
            ...
            <th valign="top">
              ...
              <p style="padding: 0px; margin: 0px; color: #333; font-size: 13px; font-weight: 400; line-height: 21px;">
              ...
              @if(!empty($patient->User->DoctorInfo->reg_no))
                Reg.No.:{{$patient->User->DoctorInfo->reg_no}}
              @endif
              </p>
              </th>
            </tr>
           ...
           <table style="width:100%; margin-top: 0px;background: #f1f1f1; padding: 5px; font-family:Arial, Helvetica, sans-serif;" class="table">
             ...
             <tr>
                <th colspan="7"><h2 style="margin: 0px; padding: 0px;">
                 <strong style=" font-size:12px; font-weight: 700; color: #000; padding-bottom: 4px;">Vitals :</strong></h2></th>
               </tr>
             <tr>
               @if(in_array(6, getAccessVitals($pVitals->added_by))) <th style="font-size:12px; vertical-align: top;">Temprature (&#176;c)</th> @endif
               @if(in_array(4, getAccessVitals($pVitals->added_by))) <th style="font-size:12px; vertical-align: top;">Blood Presssure</th> @endif
               @if(in_array(5, getAccessVitals($pVitals->added_by))) <th style="font-size:12px; vertical-align: top;">Pulse Rate</th> @endif
               @if(in_array(1, getAccessVitals($pVitals->added_by))) <th style="font-size:12px; vertical-align: top;">Height</th> @endif
               @if(in_array(2, getAccessVitals($pVitals->added_by))) <th style="font-size:12px; vertical-align: top;">Weight</th> @endif
               @if(in_array(3, getAccessVitals($pVitals->added_by))) <th style="font-size:12px; vertical-align: top;">BMI</th> @endif
               @if(in_array(7, getAccessVitals($pVitals->added_by))) <th style="font-size:12px; vertical-align: top;">Head Circumference</th> @endif
               @if(in_array(8, getAccessVitals($pVitals->added_by))) <th style="font-size:12px; vertical-align: top;">SBP</th> @endif
               @if(in_array(9, getAccessVitals($pVitals->added_by))) <th style="font-size:12px; vertical-align: top;">RBS</th> @endif
               @if(in_array(10, getAccessVitals($pVitals->added_by))) <th style="font-size:12px; vertical-align: top;">FBS</th> @endif
               @if(in_array(11, getAccessVitals($pVitals->added_by))) <th style="font-size:12px; vertical-align: top;">Temperature (&#176;f)</th> @endif
             </tr>
             </thead>
             <tbody>
             <tr>
               @if(in_array(6, getAccessVitals($pVitals->added_by))) <td style="font-size:12px; vertical-align: top;">{{$pVitals->temprature}} @if($pVitals->temprature !='') &#176;c @endif</td> @endif
               @if(in_array(4, getAccessVitals($pVitals->added_by))) <td style="font-size:12px; vertical-align: top;">{{$pVitals->bp_systolic}}@if($pVitals->bp_systolic !='' || $pVitals->bp_diastolic !='') / @endif{{$pVitals->bp_diastolic}} @if($pVitals->bp_systolic !='') mmhg @endif</td> @endif
               @if(in_array(5, getAccessVitals($pVitals->added_by))) <td style="font-size:12px; vertical-align: top;">{{$pVitals->pulse_rate}} @if($pVitals->pulse_rate !='') /Min @endif</td> @endif
               @if(in_array(1, getAccessVitals($pVitals->added_by))) <td style="font-size:12px; vertical-align: top;">{{$pVitals->heightCm}} @if($pVitals->heightCm !='') cm @endif</td> @endif
               @if(in_array(2, getAccessVitals($pVitals->added_by))) <td style="font-size:12px; vertical-align: top;">{{$pVitals->weight}} @if($pVitals->weight !='') kg @endif</td> @endif
               @if(in_array(3, getAccessVitals($pVitals->added_by))) <td style="font-size:12px; vertical-align: top;">@if($pVitals->bmi !='0'){{$pVitals->bmi}} @endif</td> @endif
               @if(in_array(7, getAccessVitals($pVitals->added_by))) <td style="font-size:12px; vertical-align: top;">{{$pVitals->head_circumference}} @if($pVitals->head_circumference !='') cm @endif</td> @endif

               @if(in_array(8, getAccessVitals($pVitals->added_by))) <td style="font-size:12px; vertical-align: top;">{{$pVitals->sbp_systolic}}@if($pVitals->sbp_systolic !='' || $pVitals->sbp_diastolic !='') / @endif{{$pVitals->sbp_diastolic}} @if($pVitals->sbp_diastolic !='') mmhg @endif</td> @endif
               @if(in_array(9, getAccessVitals($pVitals->added_by))) <td style="font-size:12px; vertical-align: top;">{{$pVitals->random_blood_sugar}} @if($pVitals->random_blood_sugar !='') mg/dl @endif</td> @endif
               @if(in_array(10, getAccessVitals($pVitals->added_by))) <td style="font-size:12px; vertical-align: top;">{{$pVitals->fasting_blood_sugar}} @if($pVitals->fasting_blood_sugar !='') mg/dl @endif</td> @endif
               @if(in_array(11, getAccessVitals($pVitals->added_by))) <td style="font-size:12px; vertical-align: top;">{{$pVitals->temperature_f}} @if($pVitals->temperature_f !='') &#176;f @endif</td> @endif
             </tr>
             </tbody>
           </table>
         </div>
          ...
          <tbody>
              <tr>
                  <td style=" width:150px" valign="top"><strong>Chief Complaint (s)</strong></td>
                    ...
                    <td style=" text-align:left; font-size:12px;">@if(!empty($chiefComplaints) > 0)
