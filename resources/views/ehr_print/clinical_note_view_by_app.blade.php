...
.table-section tbody tr td { padding-top: 10px;}
.table-section tbody tr td strong {width: 100% !important;}
...
.content { display: inherit !important; float: left;}
  ...
  <body style="font-family: sans-serif; background:#fff; ">
  	...
  	<div style="width:100%; padding:0px 0px 10px 0px;" class="clearfix">
    	<div style="width:100%; float:left; padding:0px 8px 0px 8px;">
          <div style="width:100%; margin-top:5px; position: relative;" id="logo">
           <div class="mail_dp">
           <img src="<?php 
          ...
          <div class="print-content-right" style=" width:100%; float:right;">
          <div style=" width:100%; color:#000; float:left; margin-bottom: 0px;text-align:center; font-size: 15px;">Dr.{{@$patient->User->DoctorInfo->first_name}} {{@$patient->User->DoctorInfo->last_name}}</div>
          
          <div style=" width:100%; margin-left:0px; margin-top: 0px;float: right; text-align:center;" id="company" class="clearfix">
      		<div style="color: #189ad4;font-weight:600;width: 100%;margin-bottom: 0px;font-size: 18px;padding-bottom: 0px;">{{ @$practice_detail->clinic_name }}</div>
        	<div style="width:100%; text-align:center; font-size: 14px;">{{ @$practice_detail->address_1 }},{{getCityName(@$practice_detail->city_id)}} {{getCountrieName(@$practice_detail->zipcode)}}<br> {{getStateName(@$practice_detail->state_id)}}, {{getCountrieName(@$practice_detail->country_id)}}</div>
        	<div class="contact" style="font-size: 14px; padding: 0px 0; margin: 0px 0 0px 0;">{{ @$practice_detail->mobile }}</div>
        	<div class="web-link" style=" font-size:14px; padding: 0px 0px 10px 0px;">{{ @$practice_detail->website }}</div>
      </div>
      
      	<div style=" width:100%;border-top:1px solid #189ad4; padding-top: 10px; padding-bottom: 10px; margin: 0px auto;display: table;" id="project">
            <table class="table-section" style="" cellpadding="0" cellspacing="0">
            	<tbody>
      			<tr>
      				...
      				<td style="margin-bottom: 5px; width:450px;"><strong style="margin-right:0px; width:126px; float:left;">Patient ID <span style="text-align:right; width: 50px; color: #189ad4;padding-left:16px; padding-right: 14px;"> :</span><p style=" margin-top: 0px; margin-bottom: 0px;"> </strong> {{@$patient->Patient->PatientRagistrationNumbers->reg_no}}</p></td>
        </tr>
        <tr>
    ...
    <?php //echo "<pre>";print_r($rows);?>
      ...
      <div class="content" style="width:100%;border-top: 1px solid #189ad4; margin: 0px auto; display: table; padding-top: 0px">
      	<div style="width:100%;background: #f1f1f1; padding: 10px 10px 10px 10px; float: left;">
         <h2 style="margin: 0px; padding: 0px;">
           @if(!empty($pVitals) > 0)
		  <strong style="font-size: 14px; font-weight: 700; color: #000;">Vitals :</strong></h2>
      ...
      <footer style="width:100%;margin-top:5px;color: #000; margin: 0px auto;float: left;padding-bottom: 8px;border-bottom: 2px solid #189ad4;">
				...
				<span style="width:auto; text-align:left; right: 0px; float:right;">
					...
					<img class="sign_image" style="width:120px; height:70px; background-color: #fff; color:#000;" 
					src="<?php echo getEhrUrl()."/public/doctor/signature/".$patient->User->DoctorInfo->doctor_sign;?>"/>
					@endif
				</span>
				@endif
				<div style="text-align:right; margin-bottom:0px; width:100%; float:left; border-bottom: 0px;" class="authority-signature"> 
				<p style="font-size: 11px; font-weight: 700; color: #488aff; padding-top:0px; margin:0px; width: auto; float:right;">(Authority Signature)</p>
				<div style="width:auto; float:left; padding: 0px 0px 0px 0px; text-align:right; font-size: 11px; font-weight: 700;">Powered By Healthgennie</div>
				</div>
			</footer>
      </div>
