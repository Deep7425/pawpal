  				...
  				<td colspan="2" style=" border: 1px solid #ccc; padding: 0px 50px 20px;">
  					<table cellpadding="0" cellspacing="0" style="width: 100%;">
  						<tbody>
  							...
  							<tr>
  								<td style="border: 1px solid #ccc; font-size: 14px; color: #000; padding: 5px 10px;">Doctor Name </td>
  								<td style="border: 1px solid #ccc; font-size: 14px; color: #333; padding: 5px 10px;">Dr. {{$doctor->first_name}} {{$doctor->last_name}} ({{$doctor->docSpeciality->specialities}})</td>
  							</tr>
  							<tr>
