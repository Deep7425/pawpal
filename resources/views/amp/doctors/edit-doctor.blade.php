							...
							<div class="registration-wrap doc-register">
							   ...
							   <div class="form-fields  form-field-mid pad-r0 specialization">
								...
								<div class="form-fields  form-field-mid specialization">
								  ...
								  <input class="NumericFeild yearPickEdit" type="text" name="reg_year" placeholder="Registration Year" autocomplete="off" value="{{@$docData->reg_year}}"/>
								  <span class="help-block">
								...
								<div class="form-fields  form-field-mid specialization">
								  ...
								  <input class="yearPickEdit NumericFeild" type="text" name="degree_year" placeholder="Degree Year" autocomplete="off"  value="{{@$docData->degree_year}}"/>
								  <span class="help-block">
