	...
	@if(isset($infoData))
		@if(!empty($infoData))
         <div class="listing detail-page">
            <div class="doc-img">
            <img @if(@$infoData->profile_pic != null) src="{{@$infoData->profile_pic}}" @else src="{{ URL::asset('img/doc-img.png')}}"@endif alt="icon" />                </div>
            ...
            <div class='tabsholder2'>
                  <div data-tab="Info">
                    <div class="doctor-info">
                    	<p class="doc-description">{{$infoData->content}}</p>
                        ...
                        <div class="doctor-col">
                            ...
                            @if(in_array(2,$consult_type))
								...
								<p><br><br><strong>Address:</strong> {{@$infoData->address_1}}, @if(!empty($infoData->locality_id)){{@$infoData->locality_id['name']}},@endif @if(!empty($infoData->getCityName)) {{@$infoData->getCityName->name}}, @endif {{@$infoData->getStateName->name}}</p>
