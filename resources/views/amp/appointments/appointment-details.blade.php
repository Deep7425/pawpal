	     ...
	     <div class="appointmentDetails">
	     	<div class="doc-details">
	     		<?php
	     			if(!empty(@$appointment->user->doctorInfo->profile_pic)){
					  $image_url = getEhrUrl()."/public/doctor/ProfilePics/".@$appointment->user->doctorInfo->profile_pic;
	     	...
	     	<div class="user-details">
				...
				if(!empty(@$appointment->patient->image)) {
					$image_url = getEhrUrl()."/public/patients_pics/".$appointment->patient->image;
					if(does_url_exists($image_url)) {
						$image_url = $image_url;
					}
					else{
	     		...
	     		<div class="user-documents">
	     			<div class="document-div">
	     				...
	     				<img src="{{$document['document']}}" alt="Document">
	     			</div>
	     		</div>
	     		@endforeach
	     		@else
