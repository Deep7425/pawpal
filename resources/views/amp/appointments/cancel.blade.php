                ...
                <div id="my-tab-content" class="tab-content">
						<div class="tab-pane active">
							<div class="login_sucess_inner text-center">
								...
								<div class="login_sucess_text">Your Appointment Is Not Created.</div>
                                <p>Thank you for your interest. Your appointment is not created. <br />If you have any query, please do not hesitate to call us on  <strong style=" font-family:Arial, Helvetica, sans-serif;">{{getSetting("helpline_number")[0]}}</strong></p>
								<div class="regards">
									Thanks,<br />
									Health Gennie Team.
								</div>
