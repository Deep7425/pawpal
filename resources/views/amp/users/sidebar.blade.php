...
.dashboard-wrapper.dashboard-plan-wrapper .user-detail-sidebar{ display:none;}
...
.page-container.sidebar-collapsed-back .sidebar-menu { width: 230px; transition: all .4s ease 0s;}
...
.page-container.sidebar-collapsed-back .logo {width: 100%; background: #fff; padding: 10px 10px 20px 10px; height: 70px;box-sizing: border-box; transition: all 100ms ease-in-out; position:relative;}
.user-detail-sidebar{ float:left; width:177px; position:absolute;}
.username-side{ float:left; margin:2px 0 0 10px; width:115px;}
.user-detail-sidebar h3{    margin: 0px;
    padding: 0px;
    font-size: 14px;
    color: #222;
    white-space: nowrap;
...
<div class="page-container  @if(isset($_COOKIE["in_mobile"]) && $_COOKIE["in_mobile"] == '1') sidebar-collapsed @else sidebar-collapsed-back @endif">
