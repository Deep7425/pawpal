          ...
          <div class="tab-pane active">
            <div class="login_sucess_inner text-center">
              ...
              <h1><strong>Congratulation!!</strong></h1>
				<p>Your plan has been subscribed successfully with Health Gennie. Your Subscription is active now.<br />
                If you have any query, please do not hesitate to call us on  <strong style=" font-family:Arial, Helvetica, sans-serif;">{{getSetting("helpline_number")[0]}}</strong>
                </p>
				<div class="regards">
					Thanks,<br />
					Health Gennie Team.
				</div>
                <a href="{{route('mySubscriptions')}}">Return to home page</a>
            </div>
          </div>
        </div>
      </div>
