                ...
                <tr>
                  ...
                  <td colspan="2" style="padding:0 20px 0 112px; background:#e2e2e2; border-bottom-right-radius: 10px;">
                      ...
                      <p style="font-size:13px; font-weight:bold; margin-bottom:10px; color:#28508c;">
                        {!! $practiceData->address_1 !!} @if(!empty($practiceData->locality_id)) ,{{getLocalityName($practiceData->locality_id)}}, @endif
						 @if(!empty($practiceData->city_id)) {{getCityName($practiceData->city_id)}}, @endif @if(!empty($practiceData->state_id)) {{getStateName($practiceData->state_id)}}, @endif @if(!empty($practiceData->zipcode)) {{$practiceData->zipcode}}, @endif </br>@if(!empty($practiceData->mobile)) Phone. No. : {{$practiceData->mobile}}@endif</p></td>
                </tr>
                  <tr>
                  ...
                  <tr>
                      ...
                      <a href="https://apps.apple.com/in/app/health-gennie/id1424931124" style="margin-right:10px;" target="_blank"><img src="{{URL::asset('/images/Available_on_the_App_Store.jpg')}}" /></a><a href="https://play.google.com/store/apps/details?id=com.healthgennie" target="_blank"><img src="{{URL::asset('/images/Get_it_on_Google_play.jpg')}}" /></a></td>
                </tr>
                  <tr>
                  ...
                  <td width="200" style=" background:#28508c;font-size:12px; color:#FFF; padding:0 0 10px 10px; text-align:right; padding-right:10px;">
                    <a href="https://www.facebook.com/HealthGennie/"><img src='{{getEhrUrl()."/images/facebook.png"}}'/></a>
                    <a href="https://twitter.com/HEALTHGENNIE1"><img src='{{getEhrUrl()."/images/twitter.png"}}'/></a>
                     <a href="https://www.linkedin.com/in/health-gennie-2a76a1172/"><img src='{{getEhrUrl()."/images/in.png"}}' /></a>
                   </td>
                  </tr>
                </tbody>
            </table>
