    ...
    <tr>
          <td colspan="3" class='movableContentContainer' align="center"><div class="movableContent" style="border: 0px; padding-top: 0px; position: relative;">
              ...
              <tbody>
                  ...
                  <td width="165" valign="top" height="60" style="padding-left:5px; box-sizing:border-box;" class="mail_dp"><img data-default="placeholder" data-max-width="135" data-max-height="75" src="{{URL::asset('/images/logoMail.png')}}" alt="Logo" title="Logo" width="135" height="75" ></td>
