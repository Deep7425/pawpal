    ...
    <tr>
          ...
          <td colspan="3" class='movableContentContainer' align="center"><div class="movableContent" style="border: 0px; padding-top: 0px; position: relative;">
              ...
              <tbody>
                  ...
                  <td width="165" valign="top" height="60" style="padding-left:5px; box-sizing:border-box;">
                    <img data-default="placeholder" data-max-width="135" data-max-height="75" src="{{URL::asset('/images/logoMail.png')}}" width="135" height="75" ></td>
                  ...
                  <tr>
                  <td colspan="2" style=" background:#e68f21;font-size:12px;color:#FFF; padding:15px 0 15px 10px;">Fitkid Health Tech Pvt. Ltd. All Rights Reserved</td>
                  <td width="200" class="address" style=" background:#e68f21;font-size:12px; color:#FFF !important; padding:15px 10px 15px 0;">C-94 Lal Kothi scheme, Jaipur</td>
                </tr>
                  <tr>
                  ...
                  <tr>
                  <td colspan="2" style=" background:#28508c;font-size:12px;color:#FFF; padding:15px 0 15px 10px">Email : <a href="mailto:info@healthgennie.com" style="color:#FFF; text-decoration:none;">info@healthgennie.com</a></td>
                  <td width="200" style=" background:#28508c;font-size:12px; color:#FFF; padding:15px 0; text-align:right; padding-right:10px;">
                    <a href="https://www.facebook.com/HealthGennie/"><img src="{{URL::asset('/images/facebook.png')}}"/></a>
                    <a href="https://twitter.com/HEALTHGENNIE1"><img src="{{URL::asset('/images/twitter.png')}}"/></a>
                     <a href="https://www.linkedin.com/in/health-gennie-2a76a1172/"><img src="{{URL::asset('/images/in.png')}}" /></a>
                  </td>
                </tr>
                </tbody>
            </table>
