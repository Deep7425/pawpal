...
.login_sucess_ico img{ width:60%; margin:18px 0 0 0;}
                ...
                <div id="my-tab-content" class="tab-content">
						<div class="tab-pane active">
							<div class="login_sucess_inner text-center">
								...
								<div class="login_sucess_text">Lab Order Is Not Completed.</div>
                                <p>Thank you for your intrest. Your order is not completed. <strong>Please wait while you are redirect to home page...</strong></p>
							</div>
						</div>
					</div>
            </div>
