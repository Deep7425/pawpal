  ...
  <div class="container-fluid">
      ...
      <div class="LabDetailsDivLosh">
        ...
        <div class="checkup-detail LabProfiles">
            <a href="{{route('LabDetails', ['id'=> base64_encode($item->name), 'type' => base64_encode($item->type)]) }}">
          ...
          <h3>{{$item->name}}</h3></a>
            ...
            <div class="test-included">
              <a href="{{route('LabDetails', ['id'=> base64_encode($item->name), 'type' => base64_encode($item->type)]) }}" type="{{$item->type}}">({{$item->test_count}}) Tests Included</a>
            </div>
            <div class="price-offer">
             ₹ {{$item->rate->pay_amt}}
            @if($item->rate->b2c > $item->rate->pay_amt)
...
<?php /*
    ...
    <div class="package-box">
      <h3>{{$offers->name}}</h3>
        <span class="total_count">Tests Included</span> <b>({{$offers->test_count}})</b>
        <div class="price">₹ {{$offers->rate->pay_amt}}</div>
