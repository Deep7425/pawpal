...
<div class="lab-test">
        ...
        <div class="checkup-detail item">
          ...
          <div class="certification">NABL, ISO</div>
            ...
            <div class="test-included">
                <a href="{{route('LabDetails', ['id'=> base64_encode($offer->name), 'type' => base64_encode($offer->type)])}}">({{$offer->test_count}}) Tests Included</a>
            </div>
  ...
  <div class="allProfiles">
    ...
    <div class="package-box item">
      <img src="{{ URL::asset('img/thayrocare-logo-dashboard.jpg') }}" alt="banner"  />
      <h3>{{$offer->name}}</h3>
        <span class="total_count">Tests Included</span> <b>({{$offer->test_count}})</b>
