...
@section('title', 'Laboratory Master')
@section('content')
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-bd lobidrag">
                                <div class="panel-heading">
                                    <div class="btn-group">
                                        <a class="btn btn-success" href="javascript::void(0)" data-toggle="modal" data-target="#AddModal"> <i class="fa fa-plus"></i>  Add Laboratory </a>
                                    </div>
									<div class="btn-group">
                                    ...
                                    <div class="row">
                                     <div class="panel-header panel-headerTop123">
                                        <div class="col-sm-3">
											...
											{!! Form::open(array('route' => 'admin.laboratoryMaster', 'id' => 'chnagePagination', 'method'=>'POST')) !!}
      ...
      <div class="modal-content ">
  		...
  		<div class="modal-body AddLaboratory">
  			<div class="panel panel-bd lobidrag">
  				...
  				<div class="panel-body">
  					{!! Form::open(array('id' => 'addLaboratory','name'=>'addLaboratory', 'enctype' => 'multipart/form-data')) !!}
            ...
            <div class="form-group col-sm-6">
  					...
  					<div class="form-group col-sm-6">
  						...
  						<input value="" type="number" min="0" name="price" class="form-control" placeholder="Enter Price">
...
$(document.body).on('click', '.submit', function(){
		// jQuery("#modifySubAdmin").validate({
		 jQuery("form[name='addLaboratory']").validate({
			rules: {
        vendor_id: "required",
        lab_id: "required",
        price: "required",
...
function editOrg(id) {
    ...
    type: "POST",
    dataType : "HTML",
    url: "{!! route('admin.editLaboratory')!!}",
    data:{'id':id},
    success: function(data)
    {
      jQuery('.loading-all').hide();
