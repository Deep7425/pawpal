                       ...
                       <div class="col-sm-3">
                           <div class="dataTables_length">
                              <label>Paginate By</label>
                                {!! Form::open(array('route' => 'admin.enquiryQuery', 'id' => 'chnagePagination', 'method'=>'POST')) !!}
                ...
                <div class="table-responsive">
                      <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                          ...
                          <td>
                            @if($element->status == 0)
                            <a href="javascript:void();" class="btn btn-info btn-sm enQStatusChange enQStatusChange123" rowId="{{$element->id}}" >Pending</a>
                            @else
                            <a href="javascript:void();" class="btn btn-info btn-sm"  >Done</a>
                            @endif
							<a href="javascript:void(0);" pkey="{{base64_encode(@$element->id)}}" r_from="5" class="btn btn-info btn-sm manageSprt" title="Manage Leads"><img class="customer-care-icon" src='{{ url("/img/customer-care-icon.png") }}'/></a>
                          </td>
                          </tr>
                          @endforeach
                          @else
