...
<div class="layout-wrapper layout-2">
    <div class="layout-inner">
        <div class="layout-container" style = "padding-top: 0px !important;">
			...
			<div class="row mt-2 ml-1 mb-3">

<div class="col-sm-2">
<div class="btn-group">
							<a class="btn btn-success" href="{{ route('plans.planMasterAdd') }}"> <i class="fa fa-plus"></i>  Add Plan</a>
						</div>
						<div class="btn-group">
                            ...
                            <table class="table table-bordered table-hover">
								...
								@if($plans->count() > 0)
									@foreach($plans as $index => $plan)
										...
										<td>{{$plan->lab_pkg}}</td>
										<td>
										  <button class="btn btn-default update_status" id="{{$plan->id}}" status="{{$plan->status}}" type="button">@if($plan->status == 0) Inactive @else Active @endif </button>
										</td>
										<td>
											<button onclick="editPlans({{$plan->id}});" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="left" title="Update"><i class="fa fa-pencil" aria-hidden="true"></i>Edit</button>
											<button onclick="deletePlans({{$plan->id}});" class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="right" title="Delete "><i class="fa fa-trash-o" aria-hidden="true"></i>Delete</button>
										</td>
										</tr>
										@endforeach
									@else
