...
<head>
  ...
  <link rel="shortcut icon" type="image/png" href="{{url('assets/admin/images/logos/favicon.png')}}" />
  <link rel="stylesheet" href="{{url('assets/admin/css/styles.min.css')}}" />
</head>
...
<body>
                  ...
                  <table class="table mb-0 text-nowrap varient-table align-middle fs-3">
                    ...
                    <tbody>
                      <tr>
                        <td class="px-0">
                          <div class="d-flex align-items-center">
                            <img src="{{url('assets/admin/images/profile/user-3.jpg')}}" class="rounded-circle" width="40"
                              alt="flexy" />
                            <div class="ms-3">
                      ...
                      <tr>
                        <td class="px-0">
                          <div class="d-flex align-items-center">
                            <img src="{{url('assets/admin/images/profile/user-5.jpg')}}" class="rounded-circle" width="40"
                              alt="flexy" />
                            <div class="ms-3">
                      ...
                      <tr>
                        <td class="px-0">
                          <div class="d-flex align-items-center">
                            <img src="{{url('assets/admin/images/profile/user-6.jpg')}}" class="rounded-circle" width="40"
                              alt="flexy" />
                            <div class="ms-3">
                              <h6 class="mb-0 fw-bolder">
                                Christopher Jamil
                      ...
                      <tr>
                        <td class="px-0">
                          <div class="d-flex align-items-center">
                            <img src="{{url('assets/admin/images/profile/user-7.jpg')}}" class="rounded-circle" width="40"
                              alt="flexy" />
                            <div class="ms-3">
                      ...
                      <tr>
                        <td class="px-0">
                          <div class="d-flex align-items-center">
                            <img src="{{url('assets/admin/images/profile/user-8.jpg')}}" class="rounded-circle" width="40"
                              alt="flexy" />
                            <div class="ms-3">
            ...
            <div class="card">
              ...
              <div class="comment-widgets scrollable mb-2 common-widget" style="height: 465px" data-simplebar="">
                ...
                <div class="d-flex flex-row comment-row border-bottom p-3 gap-3">
                  <div>
                    <span><img src="{{url('assets/admin/images/profile/user-3.jpg')}}" class="rounded-circle" alt="user"
                        width="50" /></span>
                  </div>
                ...
                <div class="d-flex flex-row comment-row border-bottom active p-3 gap-3">
                  <div>
                    <span><img src="{{url('assets/admin/images/profile/user-5.jpg')}}" class="rounded-circle" alt="user"
                        width="50" /></span>
                  </div>
                ...
                <div class="d-flex flex-row comment-row border-bottom p-3 gap-3">
                  <div>
                    <span><img src="{{url('assets/admin/images/profile/user-6.jpg')}}" class="rounded-circle" alt="user"
                        width="50" /></span>
                  </div>
                  <div class="comment-text w-100">
                ...
                <div class="d-flex flex-row comment-row p-3 gap-3">
                  <div>
                    <span><img src="{{url('assets/admin/images/profile/user-4.jpg')}}" class="rounded-circle" alt="user"
                        width="50" /></span>
                  </div>
                  <div class="comment-text w-100">
                    <h6 class="fw-medium">James Anderson</h6>
  ...
  <script src="{{url('assets/admin/libs/jquery/dist/jquery.min.js')}}"></script>
  <script src="{{url('assets/admin/libs/bootstrap/dist/js/bootstrap.bundle.min.js')}}"></script>
  <script src="{{url('assets/admin/js/sidebarmenu.js')}}"></script>
  <script src="{{url('assets/admin/js/app.min.js')}}"></script>
  <script src="{{url('assets/admin/libs/apexcharts/dist/apexcharts.min.js')}}"></script>
  <script src="{{url('assets/admin/libs/simplebar/dist/simplebar.js')}}"></script>
