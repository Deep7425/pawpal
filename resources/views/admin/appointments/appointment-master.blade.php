                        ...
                        <div class="btnbtn-success123">
                            ...
                            <div class="btn-group">
                                <a class="btn btn-success"
                                    href="{{ route('admin.hgAppointments',['today_appt'=>base64_encode(1),'start_date'=>base64_encode(date('Y-m-d')),'end_date'=>base64_encode(date('Y-m-d'))]) }}">Past
                                    Appointments ({{getTotalAppointmentByDate()}})</a>
                            </div>
                            @else
                            <div class="btn-group">
                                <a class="btn btn-success"
                                    href="{{ route('admin.hgAppointments',['start_date'=>base64_encode(date('Y-m-d')),'end_date'=>base64_encode(date('Y-m-d'))]) }}">Back</a>
                            </div>
                            @endif
                        </div>
                        <div class="pagination-top ml-3">
                            <div class="">
                                <!-- <label>Page</label>-->
                                {!! Form::open(array('route' => 'admin.hgAppointments', 'id' => 'chnagePagination',
                                'method'=>'POST')) !!} <input type="hidden" name="today_appt"
                                    value="@if(isset($_GET['today_appt'])) {{base64_decode($_GET['today_appt'])}} @endif" />
                                <input type="hidden" name="id"
                                    value="@if(isset($_GET['id'])) {{base64_decode($_GET['id'])}} @endif" />
                        ...
                        <div class="col-sm-2">
                            <div class="dataTables_length">
                                ...
                                <select class="form-control" name="date_type">
                                    <option value="1" @if((app('request')->input('date_type'))!='')
                                        @if(base64_decode(app('request')->input('date_type')) == '1') selected @endif
                                        @endif >Created At</option>
                                    <option value="2" @if((app('request')->input('date_type'))!='')
                                        @if(base64_decode(app('request')->input('date_type')) == '2') selected @endif
                                        @endif>Appointment</option>
                                </select>
                            </div>
                        </div>
                        <!-- DATE  FROM-->
                        ...
                        <div class="col-sm-2">
                            <div class="dataTables_length">
                                ...
                                <select class="form-control" name="app_type">
                                    ...
                                    <option value="2" @if((app('request')->input('app_type'))!='')
                                        @if(base64_decode(app('request')->input('app_type')) == '2') selected @endif
                                        @endif >Pending</option>
                                    <option value="3" @if((app('request')->input('app_type'))!='')
                                        @if(base64_decode(app('request')->input('app_type')) == '3') selected @endif
                                        @endif>Confirm</option>
                                    <option value="4" @if((app('request')->input('app_type'))!='')
                                        @if(base64_decode(app('request')->input('app_type')) == '4') selected @endif
                                        @endif>Cancel</option>
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="dataTables_length">
                                ...
                                <select class="form-control" name="type">
                                    ...
                                    <option value="3" @if((app('request')->input('type'))!='')
                                        ...
                                        @endif>PLAN</option>
                                    <option value="4" @if((app('request')->input('type'))!='')
                                        @if(base64_decode(app('request')->input('type')) == '4') selected @endif
                        ...
                        <div class="col-sm-2">
                            <div class="dataTables_length">
                                ...
                                <select class="form-control" name="pay_sts">
                                    <option value="">All</option>
                                    <option value="1" @if((app('request')->input('pay_sts'))!='')
                                        @if(base64_decode(app('request')->input('pay_sts')) == '1') selected @endif
                                        @endif >Paid</option>
                                    <option value="2" @if((app('request')->input('pay_sts'))!='')
                                        @if(base64_decode(app('request')->input('pay_sts')) == '2') selected @endif
                                        @endif>Free Direct</option>
                                    <option value="4" @if((app('request')->input('pay_sts'))!='')
                                        @if(base64_decode(app('request')->input('pay_sts')) == '4') selected @endif
                                        @endif>Free By Plan</option>
                                    <option value="3" @if((app('request')->input('pay_sts'))!='')
                                        @if(base64_decode(app('request')->input('pay_sts')) == '3') selected @endif
                                        @endif>Cash</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <div class="dataTables_length">
                                ...
                                <select class="form-control" name="user_id" id="exampleSelectMultiple">
                                    ...
                                    @if(count($practices) > 0) @foreach ($practices as $pra)
                                    <option value="{{$pra->user_id}}" @if(old('user_id')==$pra->user_id) selected @endif
                                        >{{@$pra->first_name}} {{@$pra->last_name}} ({{$pra->email}})
                        ...
                        <div class="col-sm-2">
                            <div class="dataTables_length">
                                ...
                                <select class="form-control" name="app_from">
                                    <option value="">All</option>
                                    <option value="1" @if((app('request')->input('app_from'))!='')
                                        @if(base64_decode(app('request')->input('app_from')) == '1') selected @endif
                                        @endif >Web</option>
                                    <option value="2" @if((app('request')->input('app_from'))!='')
                                        @if(base64_decode(app('request')->input('app_from')) == '2') selected @endif
                                        @endif>App</option>
                                    <option value="3" @if((app('request')->input('app_from'))!='')
                                        @if(base64_decode(app('request')->input('app_from')) == '3') selected @endif
                                        @endif>Paytm</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-2">
                            <div class="dataTables_length">
                                ...
                                <select class="form-control" name="pres_type">
                                    <option value="">All</option>
                                    <option value="1" @if((app('request')->input('pres_type'))!='')
                                        @if(base64_decode(app('request')->input('pres_type')) == '1') selected @endif
                                        @endif >Done</option>
                                    <option value="0" @if((app('request')->input('pres_type'))!='')
                                        @if(base64_decode(app('request')->input('pres_type')) == '0') selected @endif
                                        @endif>Pending</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-sm-2">
                            <div class="dataTables_length">
                                ...
                                <select class="form-control" name="code">
                                    <option value="">Select</option> @if(count(getOrganizations())>0)
                                    @foreach(getOrganizations() as $raw) <option value="{{$raw->id}}"
                                        @if(isset($_GET['code'])) @if(base64_decode($_GET['code'])==$raw->id) selected
                                        @endif @endif>{{$raw->title}}</option> @endforeach @endif
                                </select>
                            </div>
                        </div>
                        <div class="col-sm-2">
                            <div class="dataTables_length">
                                ...
                                <select class="form-control" name="appintmentstatus">
                                    ...
                                    <option value="1" @if(base64_decode(app('request')->input('appintmentstatus')) ==
                                        '1') selected @endif >Open</option>
                                    <option value="2" @if(base64_decode(app('request')->input('appintmentstatus')) ==
                                        '2') selected @endif >Closed</option>
                                </select>
                            </div>
                        </div>
...
?>
                        <tr class="tr-appointment" @if($is_next=='1' ) style="background-color: #e89e44;" @endif
                            @if($element->Patient && in_array($element->Patient->mobile_no,
                            ['9739977204','8826897971','9636257186','9769148411','9414430699']))
                            style="background-color: #7fff3133;" @endif>
                            <td>
                                <label>{{ $index + ($appointments->currentpage() - 1) * $appointments->perpage() + 1 }}.</label>
                            </td>
                            <td>{{date('d-m-Y h:i A',strtotime($element->start))}} @if(!empty($element->NotifyUserSms)
                                && $element->NotifyUserSms->status == '0')</br>
                                <div class="fa-video-camera123 blink">
                                    <i class="fa fa-video-camera" aria-hidden="true" title="video calling.."></i>
                                </div> @elseif(!empty($element->NotifyUserSms) && $element->NotifyUserSms->status ==
                                '1')</br>
                                <div class="fa-video-camera123">
                                    <i class="fa fa-video-camera" aria-hidden="true" title="video calling.."></i>
                                </div> @endif <br>{{@$element->AppointmentOrder->id}}
                            </td>
                            <td>{{getChiefComplaints($element->chiefComplaints)}}</td>
                            <td> @if(@$element->PatientLabsOne->appointment_id) <strong
                                    style="text-align:left; float:left;">Yes </strong> @else No @endif </td>
                            <td> @if(@$element->PatientDiagnosticImagings->appointment_id) <strong
                                    style="text-align:left; float:left;">Yes </strong> @else No @endif </td>
                            <td>Dr. {{@$element->User->DoctorInfo->first_name}}
                                {{@$element->User->DoctorInfo->last_name}} ({{@$element->User->id}})
                                ({{@$element->User->DoctorInfo->mobile}}) @if(!empty($element->User->DoctorInfo->acc_no)
                                && Session::get('id') ==
                                22)({{replacewithStar(@$element->User->DoctorInfo->acc_no,4)}})@endif</td>



                            <?php
                                                    //  dd($element->Patient->mobile_no);
                                                     ?>

                            <td class="showApptDtls"
                                data-pid="{{ $element->Patient ? base64_encode($element->Patient->id) : '' }}"
                                data-mobile="{{ $element->Patient ? base64_encode($element->Patient->mobile_no) : '' }}">
                                @if ($element->Patient)
                                {{ @$element->Patient->first_name }} {{ @$element->Patient->last_name }}
                                ({{ @$element->Patient->id }}) ({{ $element->Patient->mobile_no }})
                                @if (!empty($element->Patient->other_mobile_no))
                                <br>({{ $element->Patient->other_mobile_no }})
                                @endif
                                @endif
                            </td>
                            ...
                            <td>
                                ...
                                @if (!empty($element->Patient->dob))
                                <br>
                                <span>{{ get_patient_age($element->Patient->dob) }}</span>
                                @endif
                                @endif
                            </td>

                            <td>@if($element->type == '3') Tele Consult @else In Clinic @endif</td>
                            <td><span style="width:60px;"> <?php 
												$docFeeToPay=0;
                            ...
                            <td>@if(!empty($element->AppointmentOrder)){{@$element->AppointmentOrder->order_subtotal}}@else
                                {{number_format($element->consultation_fees,2)}}@endif</td>
                            <td>@if(!empty($element->AppointmentOrder)){{@$element->AppointmentOrder->order_total}}@else
                                {{number_format($element->consultation_fees,2)}}@endif</td>

                            <td>@if((!empty($element->AppointmentTxn) && @$element->AppointmentOrder->type == "1") ||
                                empty($element->AppointmentOrder)) Paid @elseif(@$element->AppointmentOrder->type ==
                                "0") Free @elseif(@$element->AppointmentOrder->type == "2") Cash @endif
                                @if(checkAppointmentIsElite($element->id,@$element->AppointmentOrder->order_by) == 1)
                                @if(in_array($element->id,$appointmentIds))
                                <span style="color: #ef6666; font-weight: bold;">(PLAN)
                                    {{$specialist_appointment_cnt}}</span>

                                @endif


                                @endif @if($element->visit_type == '6') <span
                                    style="color: #ef6666; font-weight: bold;">(Follow Up)</span> @endif
                            </td>
                            <td> @if(isset($element->AppointmentOrder)) @if($element->AppointmentOrder->order_from ==
                                '1') APP @elseif($element->AppointmentOrder->order_from == '0') WEB
                                @elseif($element->AppointmentOrder->order_from == '2') Admin @endif
                                @if(isset($meta_data->isPaytmTab) && $meta_data->isPaytmTab == "true") (Paytm)
                                @elseif(isset($meta_data->organization)) {{$meta_data->organization}} @endif @else
                                @if($element->app_click_status == '5') APP @elseif($element->app_click_status == '6')
                                WEB @endif @endif @if(isset($element->AppointmentOrder) &&
                                $element->AppointmentOrder->hg_miniApp == 1) (Help India)
                                @elseif(isset($element->AppointmentOrder) && $element->AppointmentOrder->hg_miniApp ==
                                2) (DOIT Emitra) @endif </td>
                            <td>{{$element->note}}</td>
                            <td>{{$element->is_document_uploaded == 1 ? 'Done' : 'Pending'}}</td>
                            <td class="ratingDiv">

                                <div class="ratingDivTop"> @if(isset($element->AppointmentOrder))
                                    @if(empty($element->AppointmentOrder->rating)) <select class="update_rating"
                                        appId="{{base64_encode($element->id)}}">
                                        <option value="">Select</option>
                                        <option @if($element->AppointmentOrder->rating == '1') selected @endif
                                            value="1">1 STAR</option>
                                        <option @if($element->AppointmentOrder->rating == '2') selected @endif
                                            value="2">2 STAR</option>
                                        <option @if($element->AppointmentOrder->rating == '3') selected @endif
                                            value="3">3 STAR</option>
                                        <option @if($element->AppointmentOrder->rating == '4') selected @endif
                                            value="4">4 STAR</option>
                                        <option @if($element->AppointmentOrder->rating == '5') selected @endif
                                            value="5">5 STAR</option>
                                    </select>
                                    <p class="text-success starDiv" style="display:none;">
                                        {{$element->AppointmentOrder->rating}} STAR</p> @else <p
                                        class="text-success starDiv">{{$element->AppointmentOrder->rating}} STAR</p>
                                    @endif @endif @if(!$working_status) <select class="update_appoint"
                                        apptId="{{$element->id}}">
                                        <option @if($working_status==NULL) @endif value="1">Open</option>
                                        <option @if($working_status && $working_status->status == '2') @endif
                                            value="2">Close</option>
                                    </select>
                                    <span
                                        class="cancel-btn label-default label label-success show_working_status btn-close"
                                        style="display:none;">{{"Closed"}}</span> @else <span
                                        class="btn-close cancel-btn label-default label label-success show_working_status">{{"Closed"}}</span>
                                    @endif
                                </div>
                                <br>
                            </td>
                            <td>@if(isset($element->AppointmentOrder) && !empty($element->AppointmentOrder))
                                {{date('d-m-Y h:i A',strtotime($element->AppointmentOrder->created_at))}} @else
                                {{date('d-m-Y h:i A',strtotime($element->created_at))}} @endif</td>
                            <!-- Created By -->
                            <td>{{@$element->admin->name}}</td>
                            <td>
                                <span
                                    class="btn-confirm label-default label @if($element->status != '1') label-danger @elseif($element->appointment_confirmation == '1') label-success @else label-warning @endif">@if($element->status
                                    != '1') Cancelled @elseif($element->appointment_confirmation == '1') Confirmed @else
                                    Pending @endif</span> @if($element->status == '0') @if($element->cancel_reason ==
                                "other") <span class="text-success">{{$element->other_cancel_reason}}</span> @else <span
                                    class="text-success">{{$element->cancel_reason}}</span> @endif @endif
                                @if(!empty($working_status) && $working_status->status == 1) <span
                                    class="btn-working label-default label label-success">Working</span> @endif
                                @if($element->visit_status == '1') <span class="text-success">Done</span> @else <span
                                    class="btn-pending">Pending</span> @endif
                            </td>
                            <td>
                                        ...
                                        <li>
                                            ...
                                            <ul style="width : 200px;"> <?php
                                                ...
                                                <li>
                                                    ...
                                                    <span slot_duration="{{$slot_duration}}"
                                                        app_id="{{base64_encode($element->id)}}" pId="{{$element->pId}}"
                                                        user_id="{{$user_id}}"
                                                        start_time="{{date('Y-m-d',strtotime($element->start))}}"
                                                        end_time="{{date('Y-m-d',strtotime($element->end))}}"
                                                        s_time="{{date('H:i',strtotime($element->start))}}"
                                                        e_time="{{date('H:i',strtotime($element->end))}}"
                                                        doc_id="{{$element->doc_id}}"
                                                        app_type="@if($element->type == 3){{base64_encode(1)}}@else{{base64_encode(2)}}@endif"
                                                        visit_type="{{$element->visit_type}}"
                                                        class="label-default label label-info switchOrder">
                                                        Switch</span>
                                                </li>
                                                @if(isset($element->AppointmentOrder) &&
                                                $element->AppointmentOrder->switch_apt == '1')

                                                <li class="" title="Switched From {{@$ldocN}}"><span>Switched
                                                        From<br />{{@$ldocN}}</span>
                                                </li>
                                                @endif
                                                ...
                                                <li>
                                                    @if($element->Patient)
                                                    <span class="label-default label label-info showApptDtls"
                                                        data-pid="{{ base64_encode($element->Patient->id) }}"
                                                        data-mobile="{{ base64_encode($element->Patient->mobile_no) }}">
                                                ...
                                                @if($element->type != '3')
                                                <li><span app_id="{{base64_encode($element->id)}}"
                                                        user_id="{{$user_id}}"
                                                        working-user-id="@if(!empty($working_status)){{$working_status->user_id}}@endif"
                                                        class="label-default label label-info  confirm_by_doc">
                                                        Confirm</span>
                                                </li>
                                                @endif
                                                <li>
                                                    <span app_id="{{base64_encode($element->id)}}"
                                                        user_id="{{$user_id}}"
                                                        working-user-id="@if(!empty($working_status)){{$working_status->user_id}}@endif"
                                                        class="label-default label label-info cancel_by_team ">Cancel</span>
                                                </li>
                                                <li>
                                                    <span app_id="{{base64_encode($element->id)}}"
                                                        user_id="{{$user_id}}"
                                                        working-user-id="@if(!empty($working_status)){{$working_status->user_id}}@endif"
                                                        status="@if(!empty($working_status)){{$working_status->status}}@endif"
                                                        class="label-default label @if(!empty($working_status) && $working_status->status == 1) label-danger @elseif(!empty($working_status) && $working_status->status == 2) label-success @else label-primary @endif   @if(empty($working_status) || $working_status->status != 2) start_for_work @endif "
                                                        title="Support Team work manage by Individual">@if(!empty($working_status)
                                                        && $working_status->status == 1)
                                                        Stop
                                                        @elseif(!empty($working_status) && $working_status->status == 2)
                                                        Closed
                                                        @else
                                                        Start
                                                        @endif</span>
                                                ...
                                                <li>
                                                    <a href="javascript:void(0);" id="addApptNote"
                                                        apptId="{{base64_encode($element->id)}}"
                                                        pNote="{{$element->note}}" title="Add Note"><i
                                                            class="fa fa-sticky-note-o" aria-hidden="true"></i> Add
                                                        Note</a>
                                                </li>
                                                <li>
                                                    <button class="SMsBtn"
                                                        onClick="smsView({{$element}},'{{date('d-m-Y',strtotime($element->start))}}','{{date('h:i A',strtotime($element->start))}}')">
                                                ...
                                                <li>
                                                    <button class="btn btn-info sendPres" appId="{{$element->id}}"
                                                        title="Share Prescription via whatsApp"><i
                                                            class="fa fa-share-alt" aria-hidden="true"></i> Share
                                                        Prescription
                                                    </button>
                                                </li>
                                                @endif @if($element->visit_status == '1')
                                                <li>
                                                    <button class="btn btn-info sendPresToPharmacy"
                                                        appId="{{$element->id}}"
                                                        title="Share Prescription To Pharmacy"><i
                                                            class="fa fa-share-alt" aria-hidden="true"></i>Pres Share To
                                                        Pharmacy
                                                    </button>
                                                </li>
                                                @endif @if($userModule && $element->visit_status == '1')
                                                <li>
                                                <li>
                                                    <button class="btn btn-info showPrescription"
                                                        appId="{{$element->id}}" title="Show Prescription"><i
                                                            class="fa fa-share-alt" aria-hidden="true"></i>Show
                                                        Prescription
                                                    </button>
                                                </li>
                                            </ul>
...
<div class="modal md-effect-1 md-show" id="switchDoctorModal" role="dialog" data-backdrop="static"
    data-keyboard="false">
        ...
        <div class="modal-content ">
            ...
            <div class="modal-body">
                <div class="panel panel-bd lobidrag feedback">
                    ...
                    <div class="panel-body SwitchAppointment"> <input name="app_type" value="" type="hidden" />
                        ...
                        <div class="form-groupTopMenu">
                            <div class="form-group col-md-5">
                                <label>Doctors</label>
                                <select class="form-control chooseDoc" id="chooseDoc" name="doc_id">
                                    <option value="">Select Doctor</option>
                                    @if(count($practices) > 0)
                                    @foreach($practices as $pra)
                                    @if(!empty($pra->oncall_fee) || !empty($pra->consultation_fees))
                                    <option value="{{$pra->user_id}}">{{@$pra->first_name}} {{@$pra->last_name}}
                                        ({{@$pra->email}})
                                        @if(!empty($pra->consultation_fees))({{@$pra->consultation_fees}})@endif
                                        @if(!empty($pra->oncall_fee))({{@$pra->oncall_fee}}) @endif
                                        @if(in_array($pra->user_id,$subscribedDocs))(PLAN)@endif</option>
                                    @endif
                                    @endforeach
                                    @endif
                                </select>
                                <span class="help-block"><label for="doctorSelectMultiple" generated="true"
                                        class="error" style="display:none;"></label></span>
                            </div>
                            <div class="form-group col-md-6 appDateSection">
                                <div class="appointment-popup-block appDate">
                                    <label>Date</label>
                                    <div class="dateDiv">
                                        <input type="text" class="form-control start_timeCal startDate"
                                            name="appstart_date" required readonly />
                                        <span class="input-group-addon start_timeCalIcon"><i class="fa fa-calendar"
                                                aria-hidden="true"></i></span>
						  ...
						  ?>
                                    <div class='input-group date billTimeOnTop' id='datetimepicker3'>
                                        <input type="time" class="form-control changestart_time"
                                            pattern="^([0-1]?[0-9]|2[0-4]):([0-5][0-9])(:[0-5][0-9])?$"
                                            name="appstart_time" required />
                                    </div>
                                </div>
                            </div>
                            <!--<div class="appointment-popup-block appDate">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content ">
            ...
            <div class="modal-body feedback">
                {!! Form::open(array('id' => 'addNote','name'=>'addNote')) !!} <input type="hidden" name="note_type"
                    value="2">
                <input type="hidden" name="id" id="appt_id" value="">
                <div class="form-group">
                    <label>Note:</label>
                    <textarea type="text" name="note" rows="5" class="form-control" id="appt_note"
...
<link href="{{ URL::asset('https://ajax.googleapis.com/ajax/libs/jqueryui/1.12.1/themes/ui-lightness/jquery-ui.css') }}"
    rel='stylesheet'>
...
$('#chooseDoc').select2({
    dropdownParent: $('#switchDoctorModal')
});
...
function smsView(data, date, time) {
    ...
    var doc = "Dr. " + data.user.doctor_info.first_name.charAt(0).toUpperCase() + data.user.doctor_info.first_name
        .slice(1) + " " + data.user.doctor_info.last_name;
    var type = 'tele consultaion';
    if (data.type != 3) {
        type = 'In Clinic';
    }
    var smsText = 'This patient(' + patname + ') of ' + type + ' appointment with ' + doc + ' on ' + date + ' at ' +
        time + '. Doctor Mobile : ' + data.user.doctor_info.mobile + '. Patient Mobile : ' + data.patient.mobile_no;
    alert(smsText);
    copyText(smsText);
}

jQuery(document).ready(function() {
    setTimeout(location.reload.bind(location), 1200000);
        ...
        if (confirm('Are You sure want to confirm this appointment.')) {
            ...
            jQuery.ajax({
                ...
                success: function(result) {
                    ...
                    if (result == 1) {
                        jQuery('.loading-all').hide();
                        $(confirm_btn).closest('.tr-appointment').find(".cancel-btn")
                            .addClass('label-success');
                        $(confirm_btn).closest('.tr-appointment').find(".cancel-btn")
                            .removeClass('label-warning');
                        $(confirm_btn).closest('.tr-appointment').find(".cancel-btn").html(
                            'Confirmed');
        ...
        if (confirm('Are You sure want to cancel this appointment.')) {
            ...
            jQuery.ajax({
                ...
                success: function(result) {
                    if (result == 1) {
                        jQuery('.loading-all').hide();
                        $(can_btn).closest('.tr-appointment').find(".cancel-btn")
                            .removeClass('label-success');
                        $(can_btn).closest('.tr-appointment').find(".cancel-btn").addClass(
                            'label-danger');
                        $(can_btn).closest('.tr-appointment').find(".cancel-btn").html(
                            'Cancelled');
                    } else {
                        jQuery('.loading-all').hide();
                        alert("Oops Something Problem");
        ...
        jQuery.ajax({
            ...
            success: function(result) {
                if (result == 1) {
                    jQuery('.loading-all').hide();
                    if (current_status == '') {
                        $(current).closest('.tr-appointment').find(".start_for_work")
                            .removeClass('label-primary');
                        $(current).closest('.tr-appointment').find(".start_for_work")
                            .addClass('label-danger');
                        $(current).closest('.tr-appointment').find(".start_for_work").html(
                            'Stop');
                    } else if (current_status == 1) {
                        $(current).closest('.tr-appointment').find(".start_for_work")
                            .removeClass('label-danger');
                        $(current).closest('.tr-appointment').find(".start_for_work")
                            .removeClass('start_for_work');
                        $(current).closest('.tr-appointment').find(".start_for_work")
                            .addClass('label-success');
                        $(current).closest('.tr-appointment').find(".start_for_work").html(
                            'Closed');
...
jQuery(document).on("click", ".RefundOrder", function(e) {
    $.confirm({
        ...
        content: '' + '<form action="" class="formName">' + '<div class="form-group">' +
            ...
            '<span  class="FieldError" style="display:none; color:red;"></span>' + '</div>' + '</form>',
        buttons: {
            formSubmit: {
                text: 'Submit',
                btnClass: 'btn-blue',
...
$(document).ready(function() {
    $(document.body).on('change', '.chooseDoc', function() {
        ...
        var visit_type = jQuery("form[name='switchAppointment']").find("input[name='visit_type']")
    .val();
    ...
    $(document.body).on('click', '.switchOrder', function() {
        jQuery('.loading-all').show();
        jQuery("form[name='switchAppointment']").find("input[name='app_id']").val($(this).attr(
            "app_id"));
        jQuery("form[name='switchAppointment']").find("input[name='user_id']").val($(this).attr(
            "user_id"));
        jQuery("form[name='switchAppointment']").find("input[name='pId']").val($(this).attr("pId"));
        jQuery("form[name='switchAppointment']").find("input[name='slot_duration']").val($(this).attr(
            "slot_duration"));

        jQuery("form[name='switchAppointment']").find("input[name='app_type']").val($(this).attr(
            "app_type").trim());
        ...
        jQuery("form[name='switchAppointment']").find("input[name='visit_type']").val($(this).attr(
            "visit_type"));
        ...
        jQuery("form[name='switchAppointment']").find("input[name='appstart_time']").val($(this).attr(
            "s_time"));
        jQuery("form[name='switchAppointment']").find("input[name='append_time']").val($(this).attr(
            "e_time"));
...
jQuery(document).on("change", ".changestart_time", function() {
    ...
    var selectedvar = moment(updatedEndTime).format('HH:mm');
...
<script>
jQuery(document.body).on('click', '.showApptDtls', function() {
    jQuery('.loading-all').show();
        ...
        success: function(result) {
            ...
            if (result['appts'].length > 0) {
                ...
                $.each(result['appts'], function(key, value) {
                    ...
                    var pat_name = value.patient.first_name + " " + value.patient
                        .last_name + "(" + value.patient.mobile_no + ")";
                    var doc_name = "Dr. " + value.user.doctor_info.first_name + " " + value
                        .user.doctor_info.last_name;
                    var total_rs = '';
                    var payType = '';
                    ...
                    apptTr += '<tr><td>' + key + '.</td><td>' + start + '</td><td>' +
                        doc_name + '</td><td>' + pat_name + '</td><td>' + appt_type +
                        '</td><td>' + payType + '</td><td>' + total_rs + '/-</td></tr>';
                });
                console.log(apptTr);
