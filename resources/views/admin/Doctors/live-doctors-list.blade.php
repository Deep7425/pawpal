				...
				<div class="col-sm-2">
                        ...
                        <div class="dataTables_length">
                            <div class="input-group custom-search-form">
                                <input name="search" type="text" class="form-control capitalizee"
                                    placeholder="Name, Clinic Name, Mobile" value="{{ old('search') }}" />
                            </div>
                        </div>
                    </div>
					...
					<div class="dataTables_length ml-sm-2">
                            <select class="form-control" name="filter">
                                ...
                                <option value="6" @if((app('request')->input('filter'))!='')
                                    @if(base64_decode(app('request')->input('filter')) == '6') selected @endif
                                    @endif>Plan Doctor</option>
                            </select>
                        </div>
					</div>
					<div class="col-md-2">
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>@if(in_array(1,$types) && in_array(2,$types)) BOTH @elseif(in_array(2,$types))
                                        In-clinic @elseif(in_array(1,$types)) Tele @endif</td>
                                    <td><img src="<?php
