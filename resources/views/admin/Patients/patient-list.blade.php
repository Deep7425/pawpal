    ...
    <div class="layout-inner">
        <div class="layout-container" style = "padding-top: 0px !important;">
			...
			@if(session()->get('message'))
					<div class="alert alert-success close"  data-dismiss="modal">
				 ...
				 {{app('request')->input('facility')}}
                          ...
                          <div class="btn-group btn-upload">
                               <form method="post" class="UserDataExcelImports" enctype="multipart/form-data" action="{{ route('admin.userExcelImport') }}">
									...
									<div class="TOPMENU head-small d-flex justify-content-end " id="example_length ">
			...
			<div class="layout-content card body-edit">
             ...
             <div class="row mt-2 mb-2 ml-1 mr-1" >
									  ...
									  <a href="javascript:void(0);" class="btn btn-info btn-sm sendMsgModal" ><span>Campaign</span><i class="fa fa-paper-plane" aria-hidden="true"></i></a>
									  </div>
									  </div>
			 </div>
                                ...
                                <table class="table table-bordered table-hover">
									...
									@if($patients->count() > 0)
                                        ...
                                        <tr class="tbrow">
											...
											<td class="manage-leads"><a href="javascript:void(0);" pkey="{{base64_encode(@$pat->id)}}" r_from="2" class="btn btn-info btn-sm manageSprt" title="Manage Leads"><img src='{{ url("/img/customer-care-icon.png") }}'/>Manage Leads</a></td>
											<td><div class="viewSubscription12" style = "margin-right:40px;">{{date('d-m-Y g:i A',strtotime($pat->created_at))}}</div></td>
											<td>
											<div class="viewSubscription123">
												<ul >
													<li>
														<a href="#"><i class="fa fa-bars" aria-hidden="true"></i></a>
															<ul style = "background : #ff4a00;">
																@if(!empty($pat->pId))
																<li><a href="{{ route('admin.hgAppointments',['id'=>base64_encode($pat->pId)]) }}" title="view Subscription"> Go To Appointments</a></li>
																@endif
																<li><a href="{{ route('subscription.viewSubscription',['id'=>base64_encode($pat->id)]) }}" title="view Subscription">view Subscription</a></li>
																@if(!empty($pat->pId))<li><button title="View All child users of this patient" class="showChildUser" pid="{{base64_encode($pat->pId)}}">Show Child Users</button></li>@endif
																<li><a href="{{route('admin.editUser', base64_encode($pat->id))}}" title="edit user">Edit User</a></li>

																<li><a href="javascript:void(0);" id="makeMedOrder" ppid="{{$pat->id}}" pId="{{base64_encode($pat->id)}}" title="Make Medicine Order">Make Medicine Order</a></li>
																
																<li><a href="javascript:void(0);" id="addAppt" pId="{{base64_encode($pat->id)}}" title="Create Payment Link For Appointment">Paid Appointment</a></li>
															
																<li><button style = "background : #ff4a00;" id="addFreeAppt" pId="{{base64_encode($pat->id)}}" title="Create an Free Appointment">Free Appointment</button></li>
																<li><button style = "background : #ff4a00;" title="Show All Payment Links" class="showLinks" userId="{{base64_encode($pat->id)}}">Payment Links</button></li>
																<li><button   style = "background : #ff4a00;" title="Create Lab Order" class="btn btn-default createNewOrder" type="button" pname="{{base64_encode($pat->first_name." ".$pat->last_name)}}" address="{{base64_encode(@$pat->address)}}" age="{{base64_encode(@$pat->age)}}" gender="{{base64_encode(@$pat->gender)}}" mobile_no="{{base64_encode(@$pat->mobile_no)}}"  email="{{base64_encode(@$pat->email)}}" id="{{base64_encode(@$pat->id)}}">Create Lab Order</button></li>
					...
					<div class="panel-body feedback">
						...
						<input name="Allids" value="{{json_encode($AllPatientsIds)}}" id="Allids" type="hidden"/>
							<div class="col-sm-4 filter" >
								...
								<label class="radio-inline"  style="padding-left:0px;"><input type="checkbox" name="smsFor" value="1">Send to ALL (Include Filter)</label>
						...
						<div class="col-sm-4" style="display:none;">
						<div class="form-group doctorSectionDiv doctorSectionDiv1234">
						...
						<div class="col-sm-4"  style="display:none;">
						<div class="form-group planSectionDiv doctorSectionDiv1234">
						...
						<div class="col-sm-4"  style="display:none;">
						<div class="form-group labSectionDiv doctorSectionDiv1234">
						...
						<div class="col-sm-4"  style="display:none;">
							<div class="form-group symptomSectionDiv doctorSectionDiv1234">
							...
							<div class="col-sm-4 notificationDiv">
								<label>Notification Image</label>
								<input name="notification_icon" class="form-control" type="file"/>
								<span class="help-block"></span>
							</div>

							<div class="col-sm-4 notificationDiv" style="display:none;">
		...
		<div class="modal-body">
			<div class="panel panel-bd lobidrag">
				<div class="panel-body SwitchAppointment">
					...
					<input name="user_id" value="{{$pra->user_id}}" type="hidden"/>
					...
					<div class="form-groupTopMenu  row apooint">
					...
					<div class="col-md-6 appDateSection">
...
<div class="modal fade" id="makeOrderModal" role="dialog" ></div>
<!-- The Modal -->
...
$(document).ready(function() {
	...
	$('.chooseDoc').select2({ dropdownParent: $('#switchDoctorModal') }); 
