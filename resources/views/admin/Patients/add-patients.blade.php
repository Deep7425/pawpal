...
<div class="form-top-row">
	...
	<div class="row">
		...
		<div class="col-sm-12">
			<div class="panel panel-bd lobidrag user-data-form card">
				...
				<div class="panel-body">
					...
					<div class="form-group col-sm-3">
						...
						<div class="form-group col-sm-3">
						<label style="width:100%; float:left;">DOB</label>
						<div class="input-group date" style=" width: 47%; float: left; margin-right: 2%;">
						...
						<div class="input-age-group fromDateModal" style="width: 50%; float: left;">
							<input style="width: 48%; float: left;" type="text" class="form-control age_in_number NumericFeild" placeholder="Age"/>
							<select  style="width: 49%; float: right;"name="age_in_type" class="age_in_type form-control">
