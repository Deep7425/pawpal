					  ...
					  <div class="row ml-2 mr-2 mt-2">
                                ...
                                <div class="form-group col-sm-3">
									...
									<select class="form-control lab_order" name="lab_order">
										...
										@forelse(getLabCompaniesAdmin() as $group)
                                   ...
                                   <div class="col-md-3 form-group lab-dd" id="showselect"  style="display:none">
								...
								<div class="form-group col-sm-3 GenderMaleFemale123">
									<label style="width:100%; float:left; margin-bottom:18px;">Gender:</label>
								...
								<div class="form-group col-sm-3">
									<label>E-Mail:</label>
									<input type="text" class="form-control useremail" name="email" value="@if(!empty($user->email)) {{$user->email}} @else labs@healthgennie.com @endif" placeholder="Email" >
								...
								<div class="form-group col-sm-3">
									...
									<select class="form-control payment_mode_type" name="pay_type">
										...
										<option value="7">Bank/NEFT/RTGS/IMPS</option>
										<option value="8">Credit to CCL</option>
										<option value="9">Credit to RELIABLE</option>
										<option value="10">Credit to LIVING ROOT</option> 
									</select>
								...
								<div class="form-group row payment_mode_cheque" style="display:none;">
									...
									<div class="inputBoxLoader showmessage" style="display:none"><p>Service Is Available</p>
									 ...
									 <div class="form-group col-sm-3 form-groupDate">
										<label>Schedule Date<i class="required_star">*</i></label>
									  ...
									  <div class="form-group col-sm-3">
										<label>Schedule Time<i class="required_star">*</i></label>
									...
									<div class="form-group col-sm-3">
									 ...
									 <div class="form-group col-sm-3 form-groupDate">
										<label>Create Date<i class="required_star">*</i></label>
										<div class="date-formet-section">
											<input type="text" class="createdAtDate form-control" name="created_at" style = "cursor:pointer;" placeholder="yyyy-mm-dd" value="{{date('Y-m-d')}}" readonly /><i class="fa fa-calendar" aria-hidden="true"></i>
										</div>
										<span class="help-block"></span>
									 </div>
									 ...
									 <div class="form-group col-sm-3 form-groupDate">
										...
										<div class="date-formet-section">
											<input type="text" class="transactionDate form-control" style = "cursor:pointer;" name="trans_date" placeholder="yyyy-mm-dd" value="{{date('Y-m-d')}}" readonly /><i class="fa fa-calendar" aria-hidden="true"></i>
										</div>
										<span class="help-block"></span>
									</div>
									...
									<div class="form-group col-sm-12">
										...
										<span class="help-block addressError"></span>
									</div>
...
$('.packagesAppend').on('change', function(){
	// alert(222);
