						  ...
						  <td>{{date('d M Y', strtotime($element->created_at))}} </td>
							<td>
								<div style="width: 130px;">
									...
									<a style="float:none;" href="javascript:void(0);" pkey="{{base64_encode(@$element->id)}}" r_from="4" class="btn btn-info btn-sm manageSprt" title="Manage Leads"><img src='{{ url("/img/customer-care-icon.png") }}'/></a>
								</div>
							</td>
