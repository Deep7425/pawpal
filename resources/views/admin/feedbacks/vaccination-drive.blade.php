        ...
        <div class="layout-container" style="padding-top: 0px !important;">
            ...
            <div class=" layout-content">
                    ...
                    @foreach($registrations as $index => $user)
                        ...
                        <td>{{@$user->note}}</td>
                        <td>
                          <span class="label-default btn-pending mar-r5 label @if($user->status == '1') label-success @else label-default @endif  changeStatus" status="{{$user->status}}" data-id="{{$user->id}}">@if($user->status == '1') Done @else Pending @endif</span>
