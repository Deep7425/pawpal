            ...
            <div class="container-fluid flex-grow-1 container-p-y">
                <div class="row form-top-row">
                    ...
                    <div class="btn-group form-head">
                        ...
                        {!! Form::open(array('route' => 'admin.corporateLeads', 'id' => 'chnagePagination',
                            'method'=>'POST')) !!}
                    ...
                    <div class="btn-group">
                        ...
                        <div class="head-select">
                            ...
                            <select style="height:38px" class="form-control" name="page_no" onchange="chnagePagination(this.value);">
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="javascript:void(0);" pkey="{{base64_encode(@$element->id)}}" r_from="7"
                                            class="btn btn-info btn-sm manageSprt" title="Manage Leads">
                                            <img src='{{ url("/img/customer-care-icon.png") }}' /></a>
                                    </td>
                                </tr>
                                @endforeach
                                @else
