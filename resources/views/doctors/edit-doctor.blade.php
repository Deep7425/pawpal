...
<div class="container">
    ...
    <div class="">
        <div class='example profile-detil doctor-claim-profile'>
			@if($docData->claim_status == '1' && $docData->varify_status == '0')
				<p class="uploadDocumentsWeb">Profile is under process please click link to upload documents. <span><a class="blink" href="{{route('hgOffersPlans',['doc_id'=>base64_encode($docData->id)])}}">Click here</a></span></p>
			@endif
		  ...
		  <input type="hidden" name="doc_claim_type" value="@if(!empty($docData->member_id)) {{$docData->member_id}} @endif"/>
			<div class='tabsholder1'>
			  <ul class="nav nav-tabs">
			   ...
			   <div class="tab-content">
						...
						<div class="doctor-info">
							<div class="registration-wrap doc-register">
								...
								<div class="form-fields form-field-mid pad-r0 f-name-field">
								  ...
								  <input type="text" name="first_name" placeholder="First name" value="{{@$docData->first_name}}"  />
								...
								<div class="form-fields form-field-mid pad-r0">
								  ...
								  <input type="text" name="last_name" placeholder="Last name" value="{{@$docData->last_name}}"/>
								  <span class="help-block">
								...
								<div class="form-fields form-field-mid pad-r0 gender">
								  ...
								  <div class="radio-wrap">
									<input type="radio" name="gender" id="male" value="Male" @if($docData->gender == '') checked @endif @if($docData->gender == 'Male') checked @endif >
									<label for="male">Male</label>
								  </div>
								  <div class="radio-wrap">
									<input type="radio" name="gender" id="female" value="Female" @if($docData->gender == 'Female') checked @endif>
									<label for="female">Female</label>
								  </div>
								</div>
								<div class="form-fields">
								  <label>Mobile Number({{'*******'.substr($docData->mobile_no, 7, 3)}})<i class="required_star">*</i></label>
								  <select class="countryCode" id="country" name="mobile_code" disabled>
									<option selected="selected" value="IN">+91(IND)</option>
								  </select>
								  <input v_type="1" name="mobile_no" doc_id="{{@$docData->id}}" class="s-input verifyDocData NumericFeild" type="text" placeholder="Mobile Number"  @if(isset($_GET['mbl'])) @if($_GET['mbl'] == 'true')  value="{{$docData->mobile_no}}" @endif @endif autocomplete="off"/>
								  <span class="help-block">
								...
								<div class="form-fields">
								  ...
								  <input type="text" doc_id="{{@$docData->id}}" v_type="0" name="email" placeholder="Enter Email"  @if(isset($_GET['mbl'])) @if($_GET['mbl'] == 'true')  value="{{$docData->email}}" @endif @endif  class="verifyDocData" autocomplete="off"/>
								  <span class="help-block">
									@if($errors->has('email'))
							   ...
							   <div class="form-fields  form-field-mid pad-r0 specialization">
								  ...
								  <select name="speciality" class="searchDropDown">
									<option value="">Select Speciality</option>
									@foreach (getSpecialityList() as $specialities)
									<option value="{{ $specialities->id }}" {{$docData->speciality == $specialities->id ? 'selected="selected"' : ''}}>{{ $specialities->specialities }}</option>
									@endforeach
								  </select>
                                  <span class="help-block"><label for="speciality" generated="true" class="error" style="display:none;">This field is required.</label>
								...
								<div class="form-fields">
								  ...
								  <input type="text" name="experience" placeholder="Experience" class="NumericFeild" autocomplete="off"  value="{{$docData->experience}}"/>
								    <span class="help-block">
								...
								<div class="form-fields  form-field-mid specialization">
									...
									<input type="text" name="qualification" placeholder="Qualification" value="{{@$docData->qualification}}"/>
									<span class="help-block">
								...
								<div class="form-fields  form-field-mid specialization">
								  ...
								  <input type="text" name="reg_no" placeholder="Enter Registration No" value="{{@$docData->reg_no}}"/>
								  <span class="help-block">
								...
								<div class="form-fields  form-field-mid specialization">
								  ...
								  <select name="reg_year" class="form-control">
										...
										@foreach($year as $raw)
										<option @if($docData->reg_year == $raw) selected @endif value="{{$raw}}">{{$raw}}</option>
										@endforeach
								  </select>
								  <span class="help-block">
								...
								<div class="form-fields form-field-mid pad-r0 specialization select_reg_council_div">
								  ...
								  <select name="reg_council" class="searchDropDown select_reg_council">
									...
									<option value="{{ $council->id }}" {{$docData->reg_council == $council->id ? 'selected="selected"' : ''}}>{{ $council->council_name }}</option>
									@endforeach
								...
								<div class="form-fields form-field-mid specialization reg_council_other_div" style="display:none;">
								  ...
								  <input type="text" name="reg_council_other" placeholder="Other" autocomplete="off"  />
								  <span class="help-block">
								...
								<div class="form-fields  form-field-mid specialization">
								  ...
								  <input type="text" name="last_obtained_degree" placeholder="Last Obtained Degree" autocomplete="off" value="{{@$docData->last_obtained_degree}}"/>
								  <span class="help-block">
								...
								<div class="form-fields  form-field-mid specialization">
								  ...
								  <select name="degree_year" class="form-control">
										...
										@foreach($year as $raw)
										<option @if($docData->degree_year == $raw) selected @endif value="{{$raw}}">{{$raw}}</option>
										@endforeach
								 </select>
								  <span class="help-block">
								...
								<div class="form-fields  form-field-mid pad-r0 specialization university_div">
								  ...
								  <select name="university" class="searchDropDown select_university">
									...
									<option value="{{ $university->id }}" {{$docData->university == $university->id ? 'selected="selected"' : ''}}>{{$university->name}}</option>
									@endforeach
									<option value="0">Other</option>
								  </select>
								...
								<div class="form-fields form-field-mid specialization select_other_university_div" style="display:none;">
								  ...
								  <input type="text" name="other_university" placeholder="Other" autocomplete="off" />
								  <span class="help-block">
								...
								<div class="form-fields  form-field-mid specialization">
								  ...
								  <input type="number" min="0" name="followup_count" placeholder="Followup Count" autocomplete="off" value="{{@$docData->DoctorData->followup_count}}"/>
								</div>
                <div class="add-doctor-left-box OncallStatus ConsultationType">
									<label>Consultation Type<i class="required_star">*</i></label>
                  <?php $types = []; if(!empty($docData->oncall_status)){ $types = explode(',',$docData->oncall_status); } ?>
                  <div class="ConsultationType">
                      ...
                      <p class="form-fields  form-field-mid specialization inclinic_fees"  @if(in_array(2,$types)) style="display:block;" @else style="display:none;" @endif>
        							 
        								<input class="NumericFeild" type="text" placeholder="Consultation Fee" name="consultation_fees" value="{{@$docData->consultation_fees}}" />
        								<span class="help-block">
                    ...
                    <div class="Consultation11">
                      ...
                      <p class="oncall_fee" @if(in_array(1,$types)) style="display:block;" @else style="display:none;" @endif >
    									 <input class="form-control NumericFeild" placeholder="Tele Consultation Fee" type="text" name="oncall_fee" value="{{@$docData->oncall_fee}}">
    									  <span class="help-block">
                    ...
                    <span id="oncall_status" class="help-block"></span>
								...
								<div class="form-fields  form-field-mid specialization">
								  ...
								  <textarea name="content" placeholder="Doctor Content" value="{{@$docData->content}}"> {{@$docData->content}}</textarea>
								  <span class="help-block">
								...
								<div class="form-fields form-field-mid">
									...
									<input class="form-control NumericFeild" placeholder="Account Number" type="text" name="acc_no" value="{{@$docData->acc_no}}" />
									<span class="help-block">
								...
								<div class="form-fields form-field-mid">
									<div class="middle-information-box">
									  ...
									  <input class="form-control" placeholder="Enter Account Name" type="text" name="acc_name" value="{{@$docData->acc_name}}"/>
									  <span class="help-block">
								...
								<div class="form-fields form-field-mid">
									<label class="oncall_fee123">IFSC Code</label><input class="form-control" placeholder="Enter IFSC Code" type="text" name="ifsc_no" value="{{@$docData->ifsc_no}}"/>
									  <span class="help-block">
								...
								<div class="form-fields form-field-mid">
									 <label class="oncall_fee123">Bank Name</label><input class="form-control" placeholder="Enter Bank Name" type="text" name="bank_name" value="{{@$docData->bank_name}}"/>
									  <span class="help-block">
								...
								<div class="form-fields form-field-mid">
									 <label class="oncall_fee123">Paytm Number</label><input class="form-control NumericFeild" placeholder="Enter Paytm Number" type="text" name="paytm_no" value="{{@$docData->paytm_no}}"/>
									  <span class="help-block">
								  ...
								  <label>Profile Image</label>
									<div class="image_apload22 doc_profile_image_browse">
										<div class="image_apload">
											...
											<input type="hidden" name="old_profile_pic" value="{{ @$docData->profile_pic }}"/>
									...
									<!--<div class="type_btn_main" style="display:none;">
										...
										<button class="btn btn-default take_snap" type="button" onClick="take_snapshot()">Take Snapshot</button>
										<button class="btn btn-default load_cam" type="button" onClick="loadcam()">LoadCam</button>
										</div>
									</div>-->
								</div>
								@if(!empty($docData->profile_pic_url))
								<div class="form-fields  form-field-mid specialization">
								  <label>Existing DP</label>
								  <div class="image_apload">
									<img style="background-size: cover;" class="img-update img-responsive" src="{{$docData->profile_pic_url}}" alt="icon" />
								  </div>
								</div>
								@endif
                ...
                <input class="clinic_nameBySearech" type="text" name="clinic_name" placeholder="Clinic Name" autocomplete="off" value="{{@$docData->clinic_name}}"/> <span class="help-block">
              ...
              <div class="form-fields typeField">
                ...
                <input type="radio" name="practice_type" id="clinic"value="1"  @if($docData->practice_type == '1') checked @endif>
                <label for="clinic">Clinic</label>
                </div>
                <div class="radio-wrap hospitalRadio">
                <input type="radio" name="practice_type" id="hospital"  value="2" @if($docData->practice_type == '2') checked @endif>
                ...
                <span class="help-block"><label for="practice_type" generated="true" class="error" style="display:none;">This field is required.</label>
					...
					@endif
				            ...
				            <div class="form-fields">
							  ...
							  <input class="NumericFeild" type="text" placeholder="Contact No." name="clinic_mobile" value="" />
							  <span class="help-block">
				            ...
				            <div class="form-fields">
							  <label>Email (email@mail.com)</label>
							  <input type="text" placeholder="Email Address" name="clinic_email" value="" />
							  <span class="help-block">
            				...
            				<div class="form-fields  form-field-mid specialization">
							  ...
							  <input type="text" placeholder="Recommend" name="recommend" autocomplete="off" value="{{@$docData->recommend}}"/>
							 <span class="help-block">
            				...
            				<div class="form-fields  form-field-mid specialization">
							  <label>Website (Max: 100 Character)</label>
								<input type="text" placeholder="Website" name="website" value="{{@$docData->website}}" />
								<span class="help-block">
							...
							<!--<div class="form-fields  form-field-mid specialization">
							  <label>Consultation Discounted Fee (In Digits Only)</label>
								<input class="NumericFeild" type="text" placeholder="Consultation Discount Fee" name="consultation_discount" value="{{@$docData->consultation_discount}}" />
								<span class="help-block">
            				...
            				<div class="form-fields form-field-mid specialization">
							  <label>Note(Max: 250 Character)</label>
							  <textarea name="note" placeholder="Note" value="{{@$docData->note}}" >{{@$docData->note}}</textarea>
							  <span class="help-block">
									@if($errors->has('note'))
                            ...
                            <div class="form-fields">
							  ...
							  <input type="text" placeholder="Address" name="address_1" value="{{@$docData->address_1}}" />
							  <span class="help-block">
							...
							<div class="form-fields form-field-mid specialization">
							 ...
							 <select class="country_id searchDropDown" name="country_id">
								...
								@foreach(getCountriesList() as $country)
									<option value="{{$country->id}}" @if(isset($docData->country_id)) {{$docData->country_id == $country->id ? 'selected="selected"' : ''}} @else @if($country->id=='101') selected @endif @endif >{{$country->name}}</option>
								@endforeach
							 </select>
								...
								<select class="state_id searchDropDown" name="state_id">
								 <option value="">Select State</option>
									 @foreach($stateList as $state)
										<option value="{{ $state->id }}" {{ $docData->state_id == $state->id ? 'selected="selected"' : ''}} >{{ $state->name }}</option>
									@endforeach
								</select>
							...
							<div class="form-fields  form-field-mid specialization">
							 ...
							 <option value="">Select City</option>
							  @foreach ($cityList as $city)
								<option value="{{$city->id}}" {{ $docData->city_id == $city->id ? 'selected="selected"' : ''}}>{{$city->name}}</option>
								@endforeach
							 </select>
							...
							<div class="form-fields  form-field-mid specialization">
							 ...
							 @if(count($localityList) > 0)
							   @foreach ($localityList as $locality)
								<option value="{{$locality->id}}" {{ $docData->locality_id == $locality->id ? 'selected="selected"' : ''}}>{{$locality->name}}</option>
								@endforeach
						  	 @endif
							 </select>
							...
							<div class="form-fields  form-field-mid specialization">
							  <label>Zipcode</label>
								<input class="NumericFeild" type="text" placeholder="Zipcode" name="zipcode" value="{{@$docData->zipcode}}" />
								<span class="help-block">
							...
							<div class="doctor-img form-fields form-field-mid">
								...
								<div class="image_apload">
									<p>
									<img style="background-size: cover;" id="docClinicImage" class="img-update img-responsive" src="<?php if(!empty($docData->clinic_image_url)) { ?> {{$docData->clinic_image_url}} <?php } else { ?> {{ URL::asset('img/camera-icon.jpg') }} <?php }?>" alt="icon"  />
									<input type="hidden" name="old_clinic_image" value="{{@$docData->clinic_image}}"/>
									</p>
								</div>
								<span>
             ...
             <?php
				...
				$day_in_increments = range( 0, (86400 - $increment), $increment);
				  $appt_durations = array (
	                  array('value' =>5, 'duration'=>'5 minutes'),
	                  array('value' =>10, 'duration'=>'10 minutes'),
	                  array('value' =>15, 'duration'=>'15 minutes'),
	                  array('value' =>20, 'duration'=>'20 minutes'),
	                  array('value' =>30, 'duration'=>'30 minutes'),
	                  array('value' =>45, 'duration'=>'45 minutes'),
	                  array('value' =>60, 'duration'=>'1 Hours'),
	                  array('value' =>90, 'duration'=>'1 Hour 30 minutes'),
	                  array('value' =>120, 'duration'=>'2 Hours')
	                );
			?>
					...
					<div class="checkbox-div complete-str">
						...
						<div class="opd-timings-slot">
							...
							@foreach($appt_durations as $idx => $dur)
								<option value="{{$dur['value']}}" @if($docData->slot_duration == $dur['value']) selected="selected" @endif>{{$dur['duration']}}</option>
							@endforeach
							</select>
							<span class="help-block"></span>
						</div>
						@if(!empty($docData->opd_timings))
							<?php $schdules = json_decode($docData->opd_timings);
								$row = 1;
							?>
                        ...
                        <div class="check-wrapper checkbox-div">
							<label class="chck-container">Monday
								<input type="checkbox" class="day_check" name="schedule[{{$index}}][days][]" @if(in_array('1',$schdule->days)) checked="checked" @endif  value="1">
								<span class="checkmark"></span>
							</label>
							<label class="chck-container">Tuesday
								<input type="checkbox" class="day_check" name="schedule[{{$index}}][days][]" @if(in_array('2',$schdule->days)) checked="checked" @endif  value="2">
								<span class="checkmark"></span>
							</label>

							<label class="chck-container">Wednesday
								<input type="checkbox" class="day_check" name="schedule[{{$index}}][days][]" @if(in_array('3',$schdule->days)) checked="checked" @endif  value="3">
								<span class="checkmark"></span>
							</label>

							<label class="chck-container">Thursday
								<input type="checkbox" class="day_check" name="schedule[{{$index}}][days][]" @if(in_array('4',$schdule->days)) checked="checked" @endif  value="4">
								<span class="checkmark"></span>
							</label>

							<label class="chck-container">Friday
								<input type="checkbox" class="day_check" name="schedule[{{$index}}][days][]" @if(in_array('5',$schdule->days)) checked="checked" @endif  value="5">
								<span class="checkmark"></span>
							</label>

							 <label class="chck-container">Saturday
								<input type="checkbox" class="day_check" name="schedule[{{$index}}][days][]" @if(in_array('6',$schdule->days)) checked="checked" @endif  value="6">
								<span class="checkmark"></span>
							</label>

							 <label class="chck-container">Sunday
								<input type="checkbox" class="day_check" name="schedule[{{$index}}][days][]" @if(in_array('0',$schdule->days)) checked="checked" @endif  value="0">
								<span class="checkmark"></span>
							</label>
                        </div>
                            ...
                            <label>Session {{$timecnt}}:</label>
	                            ...
	                            <div class="teleconsult_duration set_error" style="display:@if(isset($timeval->tele_appt_duration) && !empty($timeval->tele_appt_duration)) block @else none @endif;">
	                                <select name="schedule[{{$index}}][timings][{{$timecnt}}][tele_appt_duration]" class="slots">
	                                    <option value="">Select</option>
	                                  @foreach($appt_durations as $idx => $dur)
	                                    <option value="{{$dur['value']}}" @if(isset($timeval->tele_appt_duration) && $timeval->tele_appt_duration == $dur['value']) selected="selected" @endif>{{$dur['duration']}}</option>
	                                   @endforeach
	                                </select>
	                            </div>
							<div class="set_error">
                                ...
                                <div class="teleconsult_duration set_error" style="display:none;">
                                    <select name="schedule[1][timings][1][tele_appt_duration]" class="slots">
                                      ...
                                      @foreach($appt_durations as $index => $dur)
                                        <option value="{{$dur['value']}}">{{$dur['duration']}}</option>
                                       @endforeach
                                    </select>
                                </div>
								<div class="set_error">
    ...
    jQuery('.searchDropDown').on('change', function() {
          ...
          jQuery("#register-form").find(".locality_id").html('<option value="">Select Locality</option>');
			...
			function formValidate(){
				jQuery("#register-form").validate({
                    rules: {
						clinic_name:  {required:true,maxlength:255,letterswithspace: true},
						first_name: {required:true,maxlength:30,letterswithspace: true},
						last_name: {required:true,maxlength:30,letterswithspace: true},
      ...
      function addDupHiddenField(field, type){
		...
		var clinicSearchRequest;
  		jQuery(document).on("keyup paste click", ".clinic_nameBySearech", function () {
      ...
      if(jQuery(this).attr("practice_type") != "null") {
          ...
          $('#register-form').find('.country_id').val('').trigger('change');
          var countryField = $('#register-form').find('.country_id');
          addDupHiddenField(countryField, 1);
        }
        ...
        $('#register-form').find('#hospital').prop('checked', false);
		 ...
		 if($(this).is(':checked')){
		    ...
		    var slot_duration = '{{$docData->slot_duration}}';
