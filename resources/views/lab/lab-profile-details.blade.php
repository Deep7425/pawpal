...
<div class="lab-test Lab_Test_Details">
  <div class="container-fluid">
        ...
        <div class="checkup-detail">
           ...
           <div class="blog-wrapper-content">
            ...
            <div class="test-included">
              <a href="javascript:void(0);" title="({{$item->testCount}}) Tests Included">({{$item->testCount}}) Test included</a>
            </div>
      ...
      <!-- <span class="Total_Test_Lab"><h3>Total Test Included :<span> {{$item->testCount}}</span></h3></span> -->
