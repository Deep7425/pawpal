...
<link rel="preload" as="style"  href="/patient_portal_live/css/jqueryUi.css" media="all" type="text/css" defer async onload="this.onload=null;this.rel='stylesheet'"/>
<noscript><link rel="stylesheet" href="/patient_portal_live/css/jqueryUi.css"></noscript>
<script type="text/javascript" src="/patient_portal_live/js/jquery.cardtabs.js" ></script>
<script type="text/javascript" src="/patient_portal_live/js/jquery.easing.min.js" async></script>
<script type="text/javascript" src="/patient_portal_live/js/custom.js" ></script>
<script src="/patient_portal_live/js/shopifyWidgetJs.js" type="text/javascript"></script>
<script>
	...
	function getFavLabs(current) {
		...
		currentFavLabRequest = jQuery.ajax({
			...
			success: function(data){
				var rowToAppend = "";
				if(data.length > 0) {
					var search_pic = '{{ URL::asset("img/lab2-icon.png") }}';
					var pic_width  = 15;
					var pic_height = 12;
					jQuery.each(data,function(k,v) {
...
@if($controller != "HomeController" && $controller != "LabController")
<script type="text/javascript" src="/patient_portal_live/js/price_range_script.js" ></script>
<link rel="stylesheet" rel="preload" as="style"  href="/patient_portal_live/css/price_range_style.css" media="all" type="text/css" defer async />
@endif
